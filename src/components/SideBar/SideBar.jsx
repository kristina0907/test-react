...
const SideBar = ({setDisplayData}) => {
    return (
        <div className={style.sideBar}>
            <button className={style.create}><AddCircleIcon/> Create new</button>
            <div className={style.list}>
                <div className={style.item} onClick={()=>setDisplayData('even')}>
                ...
                <div className={style.item} onClick={()=>setDisplayData('odd')}>
                ...
                <div className={style.item} onClick={()=>setDisplayData('all')}>
